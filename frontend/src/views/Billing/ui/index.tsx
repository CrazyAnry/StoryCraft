            ...
            <div className={s.billingHeader}>
                <h2 className={s.planText}>
                    Ваш текущий уровень подписки: {
                        !currentUser?.plan ? "не определён" :
                            currentUser.plan.toString() === UserPlan.free.toString() ? "базовый" :
                                currentUser.plan.toString() === UserPlan.level_1.toString() ? "первый" :
                                    "второй"
                    }
                </h2>
                {currentUser?.planWillDeleteAt && <h2 className={s.planTerm}> Действует до: ${currentUser?.planWillDeleteAt.getDate()} </h2>}
            </div>
                ...
                <div className={s.planContainer}>
                    ...
                    <div className={s.planDescription}>
                        <ul>
                            ...
                            <li>Вставка картинок на общий вес не более чем на 20мб за 3 дня</li>
                        </ul>
                    </div>
                ...
                <div className={s.planContainer}>
                    ...
                    <div className={s.planDescription}>
                        <ul>
                            ...
                            <li>Неограниченное чтение историй других пользователей</li>
                            <li>Неограниченные подписки на других пользователей, а также лайки</li>
                            <li>Вставка картинок на общий вес не более чем на 50мб за 3 дня</li>
                            <li>Уникальная роль в нашем дискорд сервере</li>
                            <li>Реферальная система, которая дает одноразовую скидку 20% на все подписки</li>
                        </ul>
                    </div>
                    <div className={s.btnContainer}>
                        <button className={s.btn}>Приобрести</button>
                ...
                <div className={s.planContainer}>
                    ...
                    <div className={s.planDescription}>
                        <ul>
                            ...
                            <li>Реферальная система, которая дает одноразовую скидку 60% на все подписки</li>
