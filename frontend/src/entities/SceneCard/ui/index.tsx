...
import { AddChoiceButton, CustomCheckbox, RemoveSceneButton } from "@/shared/ui";
  ...
  return (
    ...
    <div className={styles.container}>
      ...
      <textarea
        ...
        onChange={(e) => setSceneDescription(currentScene.id!, e.target.value)}
      ...
      <div className={styles.controls}>
        <CustomCheckbox
          ...
          onChange={(val) => {
            ...
            if(val)
              setSceneMaxChoices(currentScene.id!, 0);
            else
              setSceneMaxChoices(currentScene.id!, 1);
          }}
          label="Это концовка?"
          icon={<FaCheck />}
        />
        ...
        <label className={styles.selectLabel}>
          ...
          {!currentScene.isEnd ? (
            <select
              ...
              onChange={(e) => {
                setSceneMaxChoices(currentScene.id!, parseInt(e.target.value));
              }}
      ...
      {!currentScene.isEnd && currentScene.choices?.length! > 0 && (
